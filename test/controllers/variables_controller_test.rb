...
class VariablesControllerTest < ActionController::TestCase
  ...
  test "should create variable" do
    assert_difference('Variable.count') do
      post :create, variable: { dataset_id: @variable.dataset_id, label: @variable.label, name: 'v'+@variable.name, var_type: @variable.var_type }
    end
  ...
  test "should update variable" do
    patch :update, id: @variable, variable: { dataset_id: @variable.dataset_id, label: @variable.label, name: @variable.name, var_type: @variable.var_type }
    assert_redirected_to variable_path(assigns(:variable))
  end
