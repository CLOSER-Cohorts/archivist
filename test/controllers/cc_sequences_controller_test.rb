...
#     assert_difference(CcSequence.count.to_s) do
...
#     get :show, id: @cc_sequence, format: :json, params: { instrument_id: @instrument.id }
#     assert_response :success
#   end
...
#     assert_difference(CcSequence.count.to_s, -1) do
#       delete :destroy, params: { instrument_id: @instrument.id, id: @cc_sequence }, format: :json
#     end
#     assert_response :success
#   end
# end
