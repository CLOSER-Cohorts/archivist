...
class CcConditionsControllerTest < ActionController::TestCase
  ...
  test "should create cc_condition" do
    assert_difference('CcCondition.count') do
      post :create, format: :json, cc_condition: { literal: @cc_condition.literal, logic: @cc_condition.logic, instrument_id: @instrument.id }
    end
  ...
  test "should show cc_condition" do
    get :show, format: :json, id: @cc_condition
    assert_response :success
  end

  test "should update cc_condition" do
    patch :update, format: :json, id: @cc_condition, cc_condition: { literal: @cc_condition.literal, logic: @cc_condition.logic }
    assert_response :success
  end

  test "should destroy cc_condition" do
    assert_difference('CcCondition.count', -1) do
      delete :destroy, format: :json, id: @cc_condition
    end
